            ...
            <div class="bg-image" style="background-image: url('/media/photos/photo34@2x.jpg');">
                <div class="row mx-0 bg-black-op">
                    <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                        ...
                        <div class="p-30" data-toggle="appear" data-aos="flip-left">
                    ...
                    <!-- <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-aos="fade-left"> -->
                    <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white" data-aos="fade-left">
