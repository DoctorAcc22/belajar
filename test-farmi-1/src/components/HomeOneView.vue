<template>
    ...
    <div class="banner-area content-less inc-shape">
        <div id="bootcarousel" class="carousel large-text text-light slide carousel-fade animate_text" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item bg-cover active" style="background-image: url(/img/2440x1578.png);">
                    <div class="box-table">
                ...
                <div class="carousel-item bg-cover" style="background-image: url(/img/2440x1578.png);">
                    <div class="box-table">
                        <div class="box-cell shadow dark">
                            <div class="container">
                                <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="thumb wow fadeInLeft" data-wow-delay="500ms">
                        <img src="/img/800x800.png" alt="Thumb">
                        <h2 class="wow fadeInRight" data-wow-delay="550ms"
                            style="background-image: url(/img/800x800-yellow.png);">50</h2>
                        <h4 class="wow fadeInLeft" data-wow-delay="550ms">Types of <strong>crops</strong></h4>
                    </div>
                </div>
            ...
            <div class="features-area text-center">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 single-item">
                        <div class="item">
                            <div class="thumb">
                                <img src="/img/thumb/1.png" alt="Thumb">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 single-item">
                        <div class="item">
                            <div class="thumb">
                                <img src="/img/thumb/2.png" alt="Thumb">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 single-item">
                        <div class="item">
                            <div class="thumb">
                                <img src="/img/thumb/3.png" alt="Thumb">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 single-item">
                        <div class="item">
                            <div class="thumb">
                                <img src="/img/thumb/4.png" alt="Thumb">
                            </div>
    ...
    <div class="specialty-area half-bg bg-gray overflow-hidden">
        <div class="container-full">
            <div class="specialty-items default-padding">
                <!-- Fixed BG -->
                <div class="fixed-bg bg-fixed shadow dark" style="background-image: url(/img/2440x1578.png);">
    ...
    <div class="fun-factor-area default-padding">
        ...
        <div class="illustration wow fadeInDown">
            <img src="/img/thumb/5.png" alt="Illustration">
        </div>
        <!-- End Illustration -->
        <div class="container">
            ...
            <div class="faq-items">
                <div class="row align-center">
                    ...
                    <div class="col-lg-4 thumb wow fadeInUp" data-wow-delay="550ms">
                        <img src="/img/illustration/3.png" alt="Thumb">
                    </div>
                    ...
                    <div class="col-lg-7 offset-lg-1 wow fadeInRight">
                        <div class="heading">
                            ...
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem eius soluta facere
                                eos veritatis nihil qui ipsa rem! Magni, sint eum. Excepturi natus ut, facere ipsam
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                        ...
                                        <div class="card-body">
                                            <p>
                                                Continue building numerous of at relation in margaret. Lasted engage roused
                                                mother an am at. Other early while if by do to. Missed living excuse as be.
                                                Cause heard fat above first time achivement. Discourse unwilling am no
                    ...
                    <div id="portfolio-grid" class="gallery-items colums-2">
                        ...
                        <div class="pf-item">
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <a href="/img/800x600.png" class="item popup-gallery"><i
                        ...
                        <div class="pf-item">
                            <div class="item">
                                <div class="thumb">
                                    <img src="/img/800x800.png" alt="Thumb">
                                    <a href="/img/800x800.png" class="item popup-gallery"><i
                                            class="fa fa-plus"></i></a>
                                </div>
                                <div class="info">
                                    <h4>
            ...
            <div class="tesimonials-content default-padding">
                <div class="row">
                    <div class="col-lg-4 info">
                        ...
                        <a class="btn circle btn-theme effect btn-md" href="#">View All <i
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <p>
                                            ...
                                            nature his parish boy. guest man now heard but
                                        </p>
                                        <h4>Junl Sarukh</h4>
                                        <span>Customer</span>
                                    </div>
                    ...
                    <div class="single-item col-lg-4 col-md-6">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <div class="meta">
                                    <ul>
                                        <li><a href="#"><img src="/img/100x100.png" alt="Author"> Met John</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="single-item col-lg-4 col-md-6">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <div class="meta">
                                    <ul>
                                        <li><a href="#"><img src="/img/100x100.png" alt="Author"> Mark Adam</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="single-item col-lg-4 col-md-6">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <div class="meta">
                                    <ul>
                                        <li><a href="#"><img src="/img/100x100.png" alt="Author"> Paul Ahua</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 item">
                        <div class="f-item about">
                            ...
                            <p>
                                Happen active county. Winding for the morning am shyness evident to poor. Garrets because
                                elderly new to the point.
                            </p>
                            <form action="#">
