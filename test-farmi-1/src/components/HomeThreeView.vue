<template>
                        ...
                        <div class="box-cell shadow dark">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="content">
                                            <h3 data-animation="animated zoomInRight">Original & natural</h3>
                                            <h2 data-animation="animated fadeInUp">Organic & Agriculture Products</h2>
                                            <div class="button animated fadeInUp">
                                                <a class="btn btn-gradient green circle effect btn-md" href="#">Discover
                                                    More</a>
                        ...
                        <div class="box-cell shadow dark">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="content">
                                            <h3 data-animation="animated slideInLeft">Handmade Products</h3>
                                            <h2 data-animation="animated slideInRight">Agriculture matter <br>For future
                                            </h2>
                                            <div class="button animated fadeInUp">
                                                <a class="btn btn-gradient green circle effect btn-md" href="#">Discover
                                                    More</a>
    ...
    <div class="about-content-area single-thumb overflow-hidden inc-shape default-padding">
        ...
        <div class="illustration">
            <img src="/img/shape/4.png" alt="Illustration">
        </div>
        <!-- Illustration -->
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 info">
                    <div class="content">
                        ...
                        <p>
                            ...
                            horrible margaret suitable he followed speedily. Indeed vanity excuse or mr lovers of on.
                        </p>
            ...
            <div class="tesimonials-content default-padding">
                <div class="row">
                    <div class="col-lg-4 info">
                        ...
                        <a class="btn circle btn-gradient green effect btn-md" href="#">View All <i
                                class="fas fa-angle-right"></i></a>
                    </div>
