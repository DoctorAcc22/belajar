						...
						<div class="blog-item-box">
							...
							<div class="single-item">
								<div class="item wow fadeInUp">
									<div class="thumb">
										<img src="/img/1500x700.png" alt="Thumb">
								...
								<div class="item wow fadeInUp">
									...
									<div class="info">
										<div class="meta">
											<ul>
												<li><a href="#"><i class="fas fa-user"></i> John Doe</a></li>
												<li><a href="#"><i class="fas fa-comments"></i> 54 Comments</a></li>
											</ul>
										</div>
										<h3>
											<a href="#">Always get adieus nature day course for common.</a>
										</h3>
										<p>
											Sitting mistake towards his few country ask. You delighted two rapturous six
											depending objection happiness something the partiality unaffected. Incommode so
								...
								<div class="item wow fadeInUp">
									...
									<div class="info">
										<div class="meta">
											<ul>
												<li><a href="#"><i class="fas fa-user"></i> John Doe</a></li>
												<li><a href="#"><i class="fas fa-comments"></i> 34 Comments</a></li>
											</ul>
										</div>
										<h3>
											<a href="#">Dejection incommode no listening of nature</a>
										</h3>
										<p>
											Sitting mistake towards his few country ask. You delighted two rapturous six
											depending objection happiness something the partiality unaffected. Incommode so
								...
								<ul>
									<li>
										...
										<div class="info">
											...
											<div class="meta-title">
												<span class="post-date"><i class="fas fa-calendar-alt"></i> 12 Feb,
													2021</span>
											</div>
										</div>
									</li>
									<li>
										...
										<div class="info">
											...
											<div class="meta-title">
												<span class="post-date"><i class="fas fa-calendar-alt"></i> 05 Jul,
													2019</span>
											</div>
										</div>
									</li>
									<li>
										...
										<div class="info">
											...
											<div class="meta-title">
												<span class="post-date"><i class="fas fa-calendar-alt"></i> 29 Aug,
													2021</span>
											</div>
										</div>
									</li>
