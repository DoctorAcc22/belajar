<template>
            ...
            <div class="heading-left">
                <div class="row">
                    ...
                    <div class="col-lg-6 offset-lg-1">
                        ...
                        <a class="btn circle btn-md btn-theme effect" href="#">View All <i
    ...
    <div class="history-area default-padding text-center bg-dark text-light">
        <!-- Shape -->
        <div class="fixed-shape-center" style="background-image: url(/img/shape/12.png);"></div>
        <!-- End Shape -->
        <div class="container">
            <div class="row">
        ...
        <div class="fixed-shape">
            <img src="/img/shape/brush-up.png" alt="Shape">
        </div>
        <!-- End Fixed Shape -->
    </div>
    <!-- End History Area -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 info">
                    ...
                    <p>
                        Another journey chamber way yet females man. Way extensive and dejection get delivered deficient
                        sincerity gentleman age. Too end instrument possession contrasted motionless. Calling offence six
                        joy feeling.
                    </p>
                    <div class="row">
                        ...
                        <div class="offer-pro-carousel owl-carousel owl-theme">
                            ...
                            <div class="single-item">
                                <div class="row align-center">
                                    <div class="col-lg-6">
                                        <div class="thumb">
                                            <img src="/img/800x700.png" alt="Product">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 info">
                                        <h2>Fresh Red Seedless</h2>
                                        <h4 class="price"><del>$29</del> $20</h4>
                                        <p>
                                            Lorem ipsum, dolor sit amet, consectetur adipisicing elit. Doloremque quia quos
                                            culpa corrupti. Laudantium omnis corrupti, aliquam illo blanditiis soluta
                                            reiciendis corporis numquam, neque dolores maxime, sit laborum repudiandae
                                            fugiat? consectetur adipisicing elit
                                        </p>
                                        <a class="btn circle btn-theme border btn-md" href="#"><i
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="partner-carousel owl-carousel owl-theme">
                            <img src="/img/150x80.png" alt="Partner">
                            <img src="/img/150x80.png" alt="Partner">
                            <img src="/img/150x80.png" alt="Partner">
                            <img src="/img/150x80.png" alt="Partner">
                            <img src="/img/150x80.png" alt="Partner">
                ...
                <div class="masonary">
                    <div id="portfolio-grid" class="gallery-items colums-4">
                        ...
                        <div class="pf-item">
                            <div class="item">
                                <div class="thumb">
                                    <img src="/img/800x900.png" alt="Thumb">
                                    <a href="/img/800x900.png" class="item popup-gallery"><i
