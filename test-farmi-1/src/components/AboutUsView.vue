<template>
	...
	<div class="breadcrumb-area text-center shadow dark bg-fixed text-light"
		style="background-image: url(/img/2440x1578.png);">
		<div class="container">
			<div class="row">
	...
	<div class="about-content-area overflow-hidden inc-shape default-padding">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="thumb">
						<img class="wow fadeInRight" data-wow-delay="700ms" src="/img/800x800.png" alt="Thumb">
						<img class="wow fadeInUp" data-wow-delay="1000ms" src="/img/800x800.png" alt="Thumb">
					</div>
				</div>
