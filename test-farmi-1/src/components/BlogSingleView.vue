						...
						<div class="item">
							...
							<div class="blog-item-box">
								...
								<div class="info">
									...
									<blockquote>
										Aouses or months settle remove ladies appear. Engrossed suffering supposing he
										recommend do eagerness. Commanded no of depending extremity amiable pleased.
									...
									<p>
										...
										Side in so life past. Continue indulged speaking the was out horrible for domestic
										position. Seeing rather her you not esteem men settle genius excuse. Deal say over
										you age from. Comparison new ham melancholy son themselves. projecting is devonshire
										dispatched are
									</p>
								</div>
							</div>
								...
								<div class="comments-title">
									...
									<div class="comments-list">
										<div class="commen-item">
											<div class="avatar">
												<img src="/img/800x800.png" alt="Author">
											</div>
											<div class="content">
												<div class="title">
													<h5>Bubhan Prova</h5>
													<span><i class="fas fa-calendar-alt"></i> 28 Feb, 2021 <a href="#"
															class="reply"><i class="fas fa-reply"></i> Reply</a></span>
												</div>
												<p>
										...
										<div class="commen-item reply">
											...
											<div class="content">
												<div class="title">
													<h5>Adham Botha</h5>
													<span><i class="fas fa-calendar-alt"></i> 15 Mar, 2021 <a href="#"
															class="reply"><i class="fas fa-reply"></i> Reply</a></span>
												</div>
												<p>
													Delivered ye sportsmen zealously arranging frankness estimable as. Nay
