    ...
    <div class="container mx-auto px-5 overflow-x-hidden lg:overflow-x-visible">
        <section class="grid grid-cols-none lg:grid-cols-2 pb-16 pt-8 items-center">
            <div class="lg:w-5/6 order-2 lg:order-none">
                <h1 class="text-4xl xl:text-5xl font-bold font-theme-heading text-center lg:text-left">Solusi bagi UMKM & perusahaan di Indonesia</h1>
                <p class="lg:text-xl mt-10 font-theme-content text-theme-grayish-blue text-center lg:text-left">Maksimalkan Kinerja Usaha Anda. Lebih dari 100 UMKM hingga perusahaan  telah menggunakan Doctor Accounting</p>
                <div class="flex justify-center lg:justify-start mt-10">
                    <LinkButton btn-type="danger" link="#download-section">Download</LinkButton>                    
                </div>
            </div>
