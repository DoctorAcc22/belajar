...
!(function () {
                    ...
                    value: function () {
                        jQuery('[data-toggle="appear"]:not(.js-appear-enabled)').each(function (e, t) {
                            var n = a.getWidth(),
                                ...
                                l = o.data("offset") || 0,
                                i = n < 992 ? 0 : o.data("timeout") ? o.data("timeout") : 0;
                            ...
                            t.addClass("js-click-ripple-enabled")
                                ...
                                .on("click.cb.helpers.core", function (e) {
                                    var a,
                                        ...
                                        r,
                                        l = "click-ripple";
                                    0 === t.children("." + l).length ? t.prepend('<span class="click-ripple"></span>') : t.children("." + l).removeClass("animate"),
                                        (a = t.children("." + l)).height() || a.width() || ((n = Math.max(t.outerWidth(), t.outerHeight())), a.css({ height: n, width: n })),
                ...
                },
                {
                    ...
                    value: function () {
                        jQuery(".js-filter:not(.js-filter-enabled)").each(function (e, t) {
                            var n,
                                o = jQuery(t),
                                r = jQuery(".nav-pills", o),
                                l = jQuery("a[data-category-link]", o),
                                i = jQuery("[data-category]", o),
                                s = o.data("speed") || 200;
                            o.addClass("js-filter-enabled"),
                                r.length &&
                                    jQuery(window)
                                        .on("resize.cb.helpers", function () {
                                            clearTimeout(n),
                                                (n = setTimeout(function () {
                                                    a.getWidth() < 768 ? r.addClass("flex-column") : r.removeClass("flex-column");
                                                }, 150));
                                        })
    ...
    function i(e, a) {
        return !a || ("object" !== r(a) && "function" != typeof a)
            ? (function (e) {
                ...
                (r = [
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            var a = this;
                            "init" === e
                                ? (a._lPage.addClass("side-trans-enabled"), this._uiHandleSidebars())
                                : a._lPage.hasClass("side-scroll")
                                ? (a._lSidebar.length > 0 && !a._lSidebarScroll && ((a._lSidebarScroll = new SimpleBar(a._lSidebarScrollCon[0])), jQuery(".simplebar-content-wrapper", a._lSidebar).scrollLock("enable")),
                                  a._lSideOverlay.length > 0 && !a._lSideOverlayScroll && ((a._lSideOverlayScroll = new SimpleBar(a._lSideOverlay[0])), jQuery(".simplebar-content-wrapper", a._lSideOverlay).scrollLock("enable")))
                                : (a._lSidebar &&
                                      a._lSidebarScroll &&
                                      (jQuery(".simplebar-content-wrapper", a._lSidebar).scrollLock("disable"),
                                      a._lSidebarScroll.unMount(),
                                      (a._lSidebarScroll = null),
                                      a._lSidebarScrollCon.removeAttr("data-simplebar").html(jQuery(".simplebar-content", a._lSidebar).html())),
                                  a._lSideOverlay &&
                                      a._lSideOverlayScroll &&
                                      (jQuery(".simplebar-content-wrapper", a._lSideOverlay).scrollLock("disable"),
                                      a._lSideOverlayScroll.unMount(),
                                      (a._lSideOverlayScroll = null),
                                      a._lSideOverlay.removeAttr("data-simplebar").html(jQuery(".simplebar-content", a._lSideOverlay).html())));
                        },
                    },
                    {
                        key: "_uiHandleHeader",
                    ...
                    },
                    {
                        key: "_uiHandleNav",
                        value: function () {
                            this._lPage.off("click.cb.menu"),
                                this._lPage.on("click.cb.menu", '[data-toggle="nav-submenu"]', function (e) {
                                    var a = jQuery(e.currentTarget),
                                        t = a.parent("li");
                                    return t.hasClass("open") ? t.removeClass("open") : (a.closest("ul").children("li").removeClass("open"), t.addClass("open")), a.trigger("blur"), !1;
                                });
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (t) {
                                ...
                                n && a.updateTheme(e, n), (e = jQuery("#css-theme"));
                            }
                            jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]')
                                ...
                                this._lPage.on("click.cb.themes", '[data-toggle="theme"]', function (n) {
                                    ...
                                    jQuery('[data-toggle="theme"]').parent("li").removeClass("active"),
                                        ...
                                        a.updateTheme(e, r),
                                        (e = jQuery("#css-theme")),
                                        t && Cookies.set("cbThemeName", r, { expires: 7 }),
                                        o.trigger("blur");
                                });
                        },
                    },
                        ...
                        value: function () {
                            ...
                            var n = {
                                ...
                                header_style_modern: function () {
                                    t._lPage.removeClass("page-header-glass page-header-inverse").addClass("page-header-modern"), t._uiHandleHeader();
                                },
                                header_style_classic: function () {
                                    t._lPage.removeClass("page-header-glass page-header-modern"), t._uiHandleHeader();
                                },
                                header_style_glass: function () {
                                    t._lPage.removeClass("page-header-modern").addClass("page-header-glass"), t._uiHandleHeader();
                                },
                                ...
                                header_search_off: function () {
                                    t._lHeaderSearch.removeClass("show"), t._lHeaderSearchInput.trigger("blur"), jQuery(document).off("keydown.cb.header.search");
                                },
